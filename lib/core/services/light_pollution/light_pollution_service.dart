...
import 'package:astr/core/error/light_pollution_failure.dart';
import 'package:astr/core/services/light_pollution/i_light_pollution_service.dart';
...
class LightPollutionService implements ILightPollutionService {
  ...
  Future<Result<int>> getBortleClass(Location location) async {
    ...
    final onlineResult = await _onlineSource.getBortleClass(location);
    ...
    final offlineResult = await _offlineSource.getBortleClass(location);
