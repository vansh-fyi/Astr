...
class LightPollution extends Equatable { // e.g. "4b"
  ...
  factory LightPollution.fromJson(Map<String, dynamic> json) {
    final int bortle = (json['bortle_class'] ?? json['bortle']) as int? ?? 0;
    final bool isFallback = json['fallback'] == true;
    return LightPollution(
      visibilityIndex: bortle,
      brightnessRatio: 0, // Not provided by API yet
  ...
  @override
  List<Object?> get props => <Object?>[visibilityIndex, brightnessRatio, mpsas, source, zone];
}
