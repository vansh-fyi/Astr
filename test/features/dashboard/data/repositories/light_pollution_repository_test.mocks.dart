...
// in astr/test/features/dashboard/data/repositories/light_pollution_repository_test.dart.
...
/// A class which mocks [PngMapService].
///
/// See the documentation for Mockito's code generation for more information.
class MockPngMapService extends _i1.Mock implements _i10.PngMapService {
  MockPngMapService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<void> loadMap() => (super.noSuchMethod(
        Invocation.method(
          #loadMap,
          [],
        ),
  ...
  @override
  _i8.Future<_i11.LightPollution?> getLightPollution(
          _i12.GeoLocation? location) =>
      (super.noSuchMethod(
        Invocation.method(
          #getLightPollution,
          [location],
        ),
        returnValue: _i8.Future<_i11.LightPollution?>.value(),
      ) as _i8.Future<_i11.LightPollution?>);
}
