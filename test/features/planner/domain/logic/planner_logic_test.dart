...
void main() {
  ...
  group('PlannerLogic - using QualitativeConditionService', () {
    test('should return 1 star if cloud cover > 80%', () {
      ...
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 90, moonIllumination: 0, bortleScale: 1), 1);
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 100, moonIllumination: 0, bortleScale: 1), 1);
    });
    ...
    test('should return 5 stars for perfect conditions (0% clouds, new moon, Bortle 1)', () {
      ...
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 0, moonIllumination: 0, bortleScale: 1), 5);
    });
    ...
    test('should achieve Excellent even with full moon in truly dark skies (Bortle 1)', () {
      ...
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 0, moonIllumination: 1, bortleScale: 1), 5);
    });
    ...
    test('should return 3 stars for Fair conditions (moderate clouds, full moon, Bortle 6)', () {
      ...
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 50, moonIllumination: 1, bortleScale: 6), 3);
    });
    ...
    test('should return 2 stars for Bortle 9 with clear skies (excessive light pollution)', () {
      ...
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 0, moonIllumination: 0, bortleScale: 9), 2);
    });

    test('should return 2 stars for Bortle 9 + Full Moon', () {
      // Bortle 9 -> MPSAS ~16.5, triggers "Excessive Light Pollution" -> Poor -> 2 stars
      expect(plannerLogic.calculateStarRating(cloudCoverAvg: 0, moonIllumination: 1, bortleScale: 9), 2);
    });
