...
void main() {
  ...
  group('DarknessCalculator', () {
    test('should return base MPSAS when moon is below horizon', () {
      final result = calculator.calculateDarkness(
        ...
        moonAltitude: -10.0, // Below horizon
      );
      expect(result, 21.5);
    });
    ...
    test('should return base MPSAS when moon is New (phase 0.0)', () {
      final result = calculator.calculateDarkness(
        baseMPSAS: 21.5,
        moonPhase: 0.0, // New Moon
        moonAltitude: 45.0, // High up
      );
      expect(result, 21.5);
    });
  ...
  group('getDarknessLabel', () {
    ...
    test('should return Very Poor for < 19.0', () {
      ...
      expect(calculator.getDarknessLabel(15.0).$1, 'Very Poor');
    });
  });
}
